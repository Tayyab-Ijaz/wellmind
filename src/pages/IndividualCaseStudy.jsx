...
const ALL_CASE_STUDIES = {
  ...
  'rcm-prior-authorization-intelligence': {
    ...
    overview: "This system analyzes Medicare Advantage enrollment trends, forecasts 90-day enrollment opportunities, identifies prior-authorization exposure, and highlights growth opportunities for Revenue Cycle Management teams. It's built entirely on publicly available CMS enrollment, penetration, plan, and prior-authorization benefit data, with no PHI or revenue assumptions involved.",
  ...
  'real-time-fraud-detection': {
    ...
    challenge: `A single rule-based fraud system misses evolving fraud patterns, while manual review can't scale as transaction volume grows. Any real-time system needs to balance catching fraud with not wrongly declining legitimate customers, since false blocks cost customer trust too.`,
